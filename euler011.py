...
def _main():
    ...
    for row in range(20):
        for col in range(20 - 3):
            sublist = data[row][col:col + 4]
            sets.add(multi(sublist))

    for col in range(20):
        for row in range(20 - 3):
            sublist = [data[row][col], data[row + 1][col], data[row + 2][col], data[row + 3][col]]
            sets.add(multi(sublist))

    for row in range(20 - 3):
        for col in range(20 - 3):
            sublist = [data[row][col], data[row + 1][col + 1], data[row + 2][col + 2], data[row + 3][col + 3]]
            sets.add(multi(sublist))
